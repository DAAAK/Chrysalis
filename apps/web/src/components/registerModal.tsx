...
function RegisterModal({ isOpen, closeModal }: { isOpen: any, closeModal: any }) {
                ...
                <div className="flex items-center justify-center min-h-screen px-4 text-center">
                    ...
                    <div className="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-2xl w-full">
                        <div className="bg-gray-800 px-4 py-4">
                            <h2 className="text-lg font-medium text-white">Sign Up</h2>
                        </div>
                        {errorMessage && (
                        ...
                        <div className="px-4 py-6">
                            <form onSubmit={handleRegister}>
                                <div className="mb-4">
                                    ...
                                    <input className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" type="name" placeholder="Name" value={name} onChange={handleNameChange} />
                                </div>
                                <div className="mb-4">
                                ...
                                <p className="text-gray-700 text-lg mt-4">or sign up with</p>

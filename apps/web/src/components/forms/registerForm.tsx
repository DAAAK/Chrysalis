  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center h-screen">
      <div className="flex bg-white rounded-lg shadow-md w-5/6 md:w-4/5 lg:w-3/5 border border-gray-300">
        ...
        <div className="md:w-1/2 md:p-12 border-r-2 border-white h-full flex flex-col justify-center items-center">
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col text-center items-center justify-center">
              <img src={logo} style={{ width: '185px' }} alt="logo" />
              <h4 className="my-5 pb-1 text-xl md:text-2xl lg:text-3xl font-bold">
                Nous sommes Chrysalis
              </h4>
            </div>
            <div className="items-center justify-center flex flex-col">
              <p className="my-5 text-center">Veuillez créer un compte</p>
              <input
                className="my-5 w-5/6 md:w-4/5 lg:w-3/4 xl:w-2/3 px-4 py-2 border mx-auto rounded-lg focus:outline-none focus:border-[#93d9f0]"
                type="email"
                value={email}
          ...
          <div className="flex flex-row items-center justify-center pb-4 mb-4 ">
            <span>
              ...
              <a href="/login" className="underline hover:text-[#93d9f0]">
                Cliquez ici !
              </a>
            </span>
          </div>
